...
7F.2A está cerrada en staging (aceptación superada el 2026-08-15). 7F.2B está cerrada en staging tras superar las pruebas de persistencia. 7F.2C y 7F.2D tienen su flujo principal aceptado en staging; sus gates secundarios quedan diferidos. 7F.2E ha sido cerrada y aceptada manualmente en staging. 7F.2F pasa a ser el siguiente bloque activo. La corrección de reparto de puntos que actuaba como prerrequisito se verificó manualmente en staging el 2026-08-15, sin que esa evidencia se considere aceptación de 7F.2A.
