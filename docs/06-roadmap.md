...
53. **Fase 7G.1D — Restore lógico aislado de staging:** drill documentado validando la extracción, compresión (gzip), cifrado/hashing (SHA-256) y restauración limpia de MariaDB con RTO de 5m27s, cerrando el P0 de DB para staging sin usar features bloqueadas. Producción y Media pendientes.
