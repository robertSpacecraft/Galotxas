...
3. **Fase 7G — Validación y cierre del MVP:** contrato ejecutable preparado en `29-mvp-final-acceptance-and-production-gate.md`; 7G.2 en curso (abierto por fallo en `/sitemap.xml`), 7G.3 permanece abierta, 7G.4 no iniciada. Quedan por ejecutar regresión, recorridos críticos, QA responsive/multibrowser priorizada, gates productivos, smoke y aceptación humana antes de tag/release.
